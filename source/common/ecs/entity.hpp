...
namespace our {
    ...
    public:
        ...
        std::string materialName; // Stores the materials name.
        ...
        glm::mat4 getLocalToWorldMatrixScaled(float,float); // Computes and returns the scaled transformation from the entities local space to the world space
